...
Follow the corresponding flow in `skills/fsharp-dev/SKILL.md`.
...
- Write tests using the same idioms — no mutable state in tests, use factory functions for test data, build algebra fakes as simple records.
